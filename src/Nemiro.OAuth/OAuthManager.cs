...
namespace Nemiro.OAuth
{
	...
	public static class OAuthManager
	{
		...
		/// Sets a requests provider.
		/// </summary>
		/// <param name="requestProvider">Type of requests provider that implements <see cref="T:Nemiro.OAuth.IOAuthRequestsProvider" />.</param>
		public static void SetAuthRequestsProvider(IOAuthRequestsProvider requestProvider)
		{
			if (requestProvider == null)
			{
				throw new ArgumentNullException("requestProvider");
			}
			if (RequestsProvider != null)
			{
